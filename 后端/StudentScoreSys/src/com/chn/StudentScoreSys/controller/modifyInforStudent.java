...
/**
 * Servlet implementation class modifyInforStudent
 */
@WebServlet("/modifyInforStudent")
public class modifyInforStudent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public modifyInforStudent() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean out=ss.modifyInforStudent(Sid,Sname,Sclass);	
		String ret=out? "修改学生信息成功":"修改学生信息失败";
